					...
					<div class="tab-content tab-received-content">
						...
						<div class="message-row">
							...
							<div class="column-subject" >
								<a href="../mypage/mypage-post-content.mypage" class="message-link">♚♚바둑이 오브 스☆톰♚♚가입시$$전원 포인트</a>
							</div>
						...
						<div class="message-row">
							...
							<div class="column-sender">김동건</div>
							<div class="column-subject">
								<a href="../mypage/mypage-post-content.mypage">가격 네고 희망합니다!</a>
							</div>
						...
						<div class="message-row">
							...
							<div class="column-subject">
								<a href="../mypage/mypage-post-content.mypage">배송이 완료되었습니다.</a>
							</div>
						...
						<div class="message-row">
							...
							<div class="column-sender">관리자</div>
							<div class="column-subject">
								<a href="../mypage/mypage-post-content.mypage">입찰이 완료되었습니다.</a>
							</div>
