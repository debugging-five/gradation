	...
	<div id="container-wrap">
		<div id="container">
			...
			<div id="content-wrap">
				...
				<form action="mypage-service-center-qna-update-ok.mypage?contentId=${qna.id}" method="post" enctype="multipart/form-data">
					<div id="checkboxs-wrap">						
						<span class="h5-text">구분</span>
						<span class="red-star">*</span>
						<input type="hidden" id="hidden-category" name="qnaCategory" value="${qna.qnaCategory}"/>
						<div>
			  		...
			  		<div id="title-wrap">
						...
						<span class="red-star">*</span>
			  			<input type="text" id="qna-title" name="qnaTitle" placeholder="제목을 입력하세요" value="${qna.qnaTitle}">
			  		</div>
			  		
			  		<div id="textarea-content">
						<h5>내용<span class="red-star">*</span></h5>
						<textarea id="qna-content" name="qnaContent" placeholder="내용을 입력해 주세요">${qna.qnaContent}</textarea>
					</div>
					...
					<div class="filebox">
					    ...
					    <input type="file" name="qnaImgName" id="file-input">
					</div>
