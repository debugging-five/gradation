...
<body style="margin: 0; background: #fbfcfc">
	...
	<input type="hidden" id="anPageName" name="page"
		value="our-exhibition-past-twenty-four" />
		...
		<div class="our-exhibition-past screen">
			<div class="page-header">
				...
				<div class="exhibition-name-bar group">
					<div class="current-exhibition-name pretendardh3">2024 필립
						파레노: 보이스</div>
				</div>
			</div>
			<div class="flex-row">
				<div class="left-image-column">
					<div class="exhibition-list-sidebar group">
						...
						<div class="sidebar-item-box overlap">
							<div class="sidebar-exhibition-title pretendardh7">
								<a
									href="../exhibition/our-exhibition-past-twenty-four.exhibition">2024
									필립 파레노: 보이스</a>
							</div>
						</div>
						<div class="sidebar-item-box overlap">
							<div class="sidebar-exhibition-title pretendardh7">
								<a
									href="../exhibition/our-exhibition-past-twenty-three.exhibition">2023
									아트스펙트럼</a>
							</div>
						</div>
						<div class="sidebar-item-box overlap">
							<div class="sidebar-exhibition-title pretendardh7">
								<a
									href="../exhibition/our-exhibition-past-twenty-two.exhibition">2022
									공예 지금</a>
							</div>
						</div>
					</div>
				...
				<div class="page-header-2 ">
					<img class="car-1 image"
						src="../assets/images/display/art/exhibition-past/img-past-dear-2.jpeg"
						alt="car-1" /> <img class="car-1 image"
			...
			<p>
				현재 페이지:
				<%=request.getAttribute("currentPage")%></p>
			<p>
				전체 페이지 수:
				<%=request.getAttribute("totalPages")%></p>
		</div>
	</div>
